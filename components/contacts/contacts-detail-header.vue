  ...
  <header class="pa3 pl4 pr24 bg-white bb b--purple-gray z-10">
    <div class="flex items-center justify-between">
      <div class="flex items-center">
        <div class="br b--light-gray flex items-center pv2 pr3">
          <back-link
            text="Contacts"
            destination="/contacts"
            class="contacts__back"/>
        </div>

        <miso-heading
          level="3"
          class="mv0 pl3 dark-gray-accent flex items-center">
          <span class="mr2">{{ contact && contact.full_name }}</span>

          <!-- New mockups don't have star button yet -->
          <!-- <miso-button type="transparent" size="tiny" class="pa0">
            <feather-icon name="star" height="20" width="20"></feather-icon>
          </miso-button> -->
        ...
        <div class="flex flex-auto ph3 bl br b--light-gray">
          ...
          <popper :options="{ placement: 'bottom' }">
            ...
            <miso-button
              slot="reference"
              type="transparent"
              class="nav__button dark-gray mid-gray hover-dark-gray header-take-note-button"
