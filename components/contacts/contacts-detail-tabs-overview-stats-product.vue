...
export default {
  name: 'ContactsDetailTabsOverviewStatsProduct',
  ...
  watch: {
    contact: function (newContact, oldContact) {
      if (newContact && this.reviewContactId) {
        this.fetchMetricsByContact(this.reviewContactId)
      }
    }
  },

  methods: {
    ...mapActions(['changeTab', 'fetchMetricsByContact']),
