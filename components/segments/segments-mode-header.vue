<template>
  <header class="pa3 pl4 bg-white bb b--purple-gray z-10">
...
export default {
  ...
  methods: {
    ...
    reset () {
      this.updateSegmentMode(null)
      this.onHideSidePanel()
      this.resetSegmentFormData()
      this.setSegmentViewId(null)
    },
